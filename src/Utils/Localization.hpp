...
namespace Utilities
{
	namespace Localization
	{
		...
		{
			std::ifstream file(FileHelper::GetNormalizeFilePath(localeFilePath));
			if(file.is_open())
			{
				std::string line;
		...
		{
			std::ofstream file(Utilities::FileHelper::GetNormalizeFilePath(localeFilePath));
			if(file.is_open())
			{
